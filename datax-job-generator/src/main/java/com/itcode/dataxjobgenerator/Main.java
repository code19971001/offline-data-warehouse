package com.itcode.dataxjobgenerator;

import cn.hutool.json.JSONUtil;
import com.itcode.dataxjobgenerator.bean.Table;
import com.itcode.dataxjobgenerator.config.Configuration;
import com.itcode.dataxjobgenerator.helper.DataxJsonHelper;
import com.itcode.dataxjobgenerator.helper.MysqlHelper;
...
public class Main {
    public static void main(String[] args) throws IOException {
        // 生成 HDFS 入方向配置文件
        System.out.println(Configuration.IMPORT_OUT_DIR);
        if (!StringUtils.isNullOrEmpty(Configuration.IMPORT_OUT_DIR)) {
            System.out.println("start to generator import hdfs config");
        ...
        // 生成 HDFS 出方向配置文件
        if (!StringUtils.isNullOrEmpty(Configuration.EXPORT_OUT_DIR)) {
            MysqlHelper mysqlHelper = new MysqlHelper(
