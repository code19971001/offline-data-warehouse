...
#####################################################
##author: code1997
##desc: used to load data from mysql to hdfs
##example: ./mysql_to_hdfs_init.sh all 2021-10-17
#####################################################
...
import_data() {
  $sqoop import \
    --connect jdbc:mysql://hadoop02:3306/$APP \
    --username root \
    --password 19971001 \
  ...
  hadoop jar /opt/module/hadoop-3.1.3/share/hadoop/common/hadoop-lzo-0.4.21-SNAPSHOT.jar com.hadoop.compression.lzo.DistributedLzoIndexer /origin_data/$APP/db/$1/$do_date
}
